...
test('resources register the extraInfo, storyLab and videoEditor namespaces', async () => {
  ...
  assert.deepEqual([...NAMESPACES], ['common', 'navigation', 'settings', 'wizard', 'activity', 'extraInfo', 'storyLab', 'director', 'seriesLab', 'videoEditor', 'workspaces', 'styleSheet', 'projects', 'auditDev', 'scene3d', 'scene3dEditor', 'kineticText', 'shell', 'characters', 'comics', 'studio'])
