...
2. In Pinokio, open the **Discover** tab and paste `https://github.com/IAnMove/hocuspocus` — or click the **Download** button on the [HocusPocus repo page](https://github.com/IAnMove/hocuspocus).
