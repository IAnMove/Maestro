...
OPERATIONS = {
    ...
    'scenes.effects.catalog': (Strict, 'List 30 screen overlays and the 3 world-space kinds (portal, magic_circle, summoning_gate). Screen uses percent; world uses meters. No AI generation.'),
