...
_ARCHITECTURES = {
    "h3_advanced_fl2va": "fl2va",
    "h3_advanced_fl2va_pruned": "fl2va",
    "h3_advanced_ref2va": "ref2va",
    "h3_advanced_ref2va_pruned": "ref2va",
    "viggle_animate": "viggle",
    "h3_advanced_tts_ref2va_pruned": "ref2va",
    "h3_advanced_vdn": "fl2va",
    "h3_advanced_vdn_pruned": "fl2va",
}
_LORA_SUFFIXES = (
...
def _load_affine_package(architecture, width=8):
    ...
    from shared.wangp1272.assets import affine_package
    tensors = load_file(str(affine_package(f"{architecture}_rank{package_width}.sft")), device="cpu")
