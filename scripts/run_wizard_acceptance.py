...
def main() -> int:
    ...
    parser.add_argument('--scenario', choices=('smoke', 'full', 'studio', 'language', 'music-video', 'music-video-new', 'comic', 'series', 'failure', 'cancel', 'workspace', 'wizard-media', 'app-tour', 'app-generate', 'app'), default='smoke')
